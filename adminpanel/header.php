                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="viewproducts.php" class="dropdown-item">View</a>
                        </div>
                    </div>
                    <a href="feedback.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>FEEDBACK</a>
                    <a href="order.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>ORDERS</a>
                    <a href="invoice.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>INVOICE </a>

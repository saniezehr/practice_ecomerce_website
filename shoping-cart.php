...
if(isset($_POST['addToCart'])){
	if(isset($_SESSION['cart'])){
		...
		if(in_array($_POST['pId'] ,$productId)){
			echo "<script>alert('product is alreay exist')</script>";
		}
		else{
								...
								<tr class="table_row">
									...
									<td class="column-4">
										...
										<input type="hidden" class="productId" value="<?php echo $value['p_id'] ?>">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="<?php echo $value['p_qty']?>">
									...
									<td><a  href="?remove=<?php echo $value['p_id']?>" class="btn btn-danger ">Remove</a>
	</td>
